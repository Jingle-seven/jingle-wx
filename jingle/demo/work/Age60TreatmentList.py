...
escapeNames = ['戴金兰','谭大妹','钟达海','陈如章','刘荣','李英山','戴东北','蓝善付','','刘开琼','黄井妹','陈石妹','','','']
hadNames = ['吴林凤','何文鲜','谢加贤','刘洪疆','谢水妹','叶会兰','廖茂生','周礼信','何腾英','刘庭勇','欧阳过房','蒲诗兵'
    ,'曾广书','何明凤','张万凤','龚恩富','邓光林','姚大凤','曾六六','邓秀英','林发栋','李德顺','钟达胜','张振文','张振忠'
    ,'陈礼文','丘万顺','何新福','钟达银','吴绍明','邱桂英','梁兴妹','刘红安','邱四妹','李庚凤','刘冬妹','邱昌光','钟秀兰'
    ,'欧阳二林','阳石桥','刘洪安','丘桂英','陈金星','沈六凤','','','','','','','','','']
escapeNames = escapeNames + hadNames
print(escapeNames)
xlsName = '21年4月农保待遇核定'
...
for line in txtFile:
    ...
    monthToBePaid = (birthYear - 1951) * 12
    # print(row[3][6:10],monthToBePaid,row[5] == str(monthToBePaid))
    if int(row[5]) >= monthToBePaid:
        row[0] = paidCount
